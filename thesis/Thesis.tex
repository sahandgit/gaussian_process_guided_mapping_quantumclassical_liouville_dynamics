...
contraction. For both stochastic moving-cloud methods, PBME and MIDPOINT,
both differences must also exceed the pooled independent-seed variation. Thus a ratio of two
...
PBME & 20 & $M^{\rm signed}_{2,R}$ & $2.31$ & $2.31$ & $2.31$ & $4.89\times10^{-7}$ & $1.22\times10^{-7}$ & step-size signal is not resolved above seed spread \\
PBME & 20 & $M^{\rm signed}_{2,P}$ & $1.66$ & $1.66$ & $1.66$ & $3.00\times10^{-6}$ & $7.49\times10^{-7}$ & step-size signal is not resolved above seed spread \\
...
PBME & 100 & $M^{\rm signed}_{2,R}$ & $0.985$ & $0.985$ & $0.985$ & $1.81\times10^{-7}$ & $4.51\times10^{-8}$ & step-size signal is not resolved above seed spread \\
PBME & 100 & $M^{\rm signed}_{2,P}$ & $0.444$ & $0.444$ & $0.444$ & $7.48\times10^{-6}$ & $1.87\times10^{-6}$ & step-size signal is not resolved above seed spread \\
...
MIDPOINT & 20 & $M^{\rm signed}_{2,R}$ & $-1.52\times10^{3}$ & $-5.07$ & $-13.1$ & $503$ & $8.38$ & step-size signal is not resolved above seed spread \\
MIDPOINT & 20 & $M^{\rm signed}_{2,P}$ & $-2.67\times10^{3}$ & $11.4$ & $-13.4$ & $1.94\times10^{3}$ & $82.5$ & step-size signal is not resolved above seed spread \\
...
MIDPOINT & 100 & $M^{\rm signed}_{2,R}$ & $-1.02\times10^{44}$ & $-1.27\times10^{43}$ & $-6.88\times10^{45}$ & $2.95\times10^{43}$ & $2.01\times10^{45}$ & nonmonotone step-size response \\
MIDPOINT & 100 & $M^{\rm signed}_{2,P}$ & $-5.96\times10^{45}$ & $-9.50\times10^{44}$ & $-4.79\times10^{47}$ & $3.06\times10^{45}$ & $2.38\times10^{47}$ & nonmonotone step-size response \\
\end{longtable}
\endgroup
\end{landscape}
